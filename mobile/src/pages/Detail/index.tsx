...
const Detail = () => {
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        {/*
          Usamos `SafeAreaView` para que o app tenha um "padding"
          agradável com relação a status bar e o fim da tela 
        */}
        ...
        <View style={styles.footer}>
          ...
          <RectButton style={styles.button} onPress={() => handleMailMessage()}>
